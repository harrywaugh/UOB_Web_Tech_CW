...
let db = new sqlite3.Database('./db/users.db', (err) => {
  ...
  db.exec(db_schema, () => {
    ...
    replies_insert_reply.run([3, "We're working on a range of new skins for your chefs! They will be released very soon...", "KhaosKitchen", now.getTime() - 30*60*60*1000]);
